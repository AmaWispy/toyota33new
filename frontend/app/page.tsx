...
export const metadata: Metadata = {
  description:
    'Тойота33: более 20 лет обслуживания японских и европейских автомобилей во Владимире. Сертифицированные специалисты, оригинальные запчасти, честные цены. ТО, диагностика, ремонт. Онлайн-запись.',
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Оставьте заявку и мы свяжемся с вами в течение рабочего дня. Работаем понедельник–пятница с 9:00 до 18:00.
              </p>
